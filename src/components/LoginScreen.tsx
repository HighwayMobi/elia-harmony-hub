  ...
  return (
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full h-12 bg-[#A36BFF] hover:bg-[#efe0cc] text-[#F5E6D3] font-medium rounded-xl transition-all disabled:opacity-50"
          >
            {loading ? (
      ...
      <Dialog open={forgotOpen} onOpenChange={setForgotOpen}>
        <DialogContent className="sm:max-w-md border-0 rounded-3xl bg-[#F5E6D3] text-white shadow-2xl [&>button]:text-white/70 [&>button]:hover:text-white">
          <DialogHeader>
            ...
            <div className="flex rounded-xl bg-white/15 p-1">
              <button
                ...
                className={`flex flex-1 items-center justify-center gap-2 rounded-lg py-2.5 text-sm font-semibold transition-all ${
                  forgotTab === "email"
                    ? "bg-white/90 text-[#F5E6D3] shadow-sm"
                    : "text-white/80 hover:text-white"
                }`}
              >
      ...
      >
        <DialogContent
          className="sm:max-w-md border-0 rounded-3xl bg-[#F5E6D3] text-white shadow-2xl [&>button]:hidden"
        ...
        >
          ...
          <div className="space-y-3 pt-2">
            ...
            <Button
              ...
              className="w-full h-12 bg-[#A36BFF] hover:bg-[#efe0cc] text-[#F5E6D3] font-medium rounded-xl transition-all"
            >
              CONTINUAR
            </Button>
          </div>
